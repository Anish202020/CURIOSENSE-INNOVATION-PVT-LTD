    ...
    <footer className="text-gray-600 body-font">
        ...
        <div className="w-1/2 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a href="/home" className="flex title-font font-medium text-center items-center md:justify-start justify-center">
            <Image src="https://i.ibb.co/fXPdQwX/logo.jpg"
              ...
              alt="logo" border="0" />
            {/* <span className="ml-3  text-xl"/>CURIOSENSE INNOVATION PRIVATE LIMITED</span> */}

          </a>

          <p className="mt-2 text-xl text-gray-500">CURIOSENSE INNOVATION PRIVATE LIMITED</p>
        </div>
        <div className="">
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 CURIOSENSE INNOVATION PRIVATE LIMITED —
