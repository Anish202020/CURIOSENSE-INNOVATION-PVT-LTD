    ...
    return (
        <div>
            ...
            <section className="text-gray-600 body-font">
                ...
                <Link className="text-sm text-center bg-green-600 text-white font-bold w-full cursor-pointer text-center px-6 py-2 mt-3 text-right" href={"https://forms.gle/fFnK5oJok1jjyQ3f7"}><span >Order Now!</span></Link>
                </div>
            </section>
        </div>
    )
