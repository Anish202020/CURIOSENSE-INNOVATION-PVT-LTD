          ...
          <div className="flex flex-wrap -m-4">
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                <img alt="gallery" className="absolute inset-0 w-full h-full  " src="https://i.ibb.co/34NsYGd/download-1.webp" />
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                <img alt="gallery" className="absolute inset-0 w-full h-full  " src="https://i.ibb.co/gZ1ydN6/download.jpg" />
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  <h2 className="tracking-widest text-sm title-font font-medium text-green-500 mb-1">CURIOSENSE INNOVATION PRIVATE LIMITED</h2>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                <img alt="gallery" className="absolute inset-0 w-full h-full  " src="https://i.ibb.co/tDnsj0z/download-9.jpg" />
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  <h2 className="tracking-widest text-sm title-font font-medium text-green-500 mb-1">CURIOSENSE INNOVATION PRIVATE LIMITED</h2>
                  <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Believes in...</h1>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                <img alt="gallery" className="absolute inset-0 w-full h-full  " src="https://i.ibb.co/LRTJnw0/download-10.jpg"/>
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  <h2 className="tracking-widest text-sm title-font font-medium text-green-500 mb-1">CURIOSENSE INNOVATION PRIVATE LIMITED</h2>
                  <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Believes in...</h1>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                ...
                <img alt="gallery" className="absolute inset-0 w-full h-full  " src="https://i.ibb.co/nRjCQf1/download-5.jpg" />
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  <h2 className="tracking-widest text-sm title-font font-medium text-green-500 mb-1">CURIOSENSE INNOVATION PRIVATE LIMITED</h2>
                  <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Believes in...</h1>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                <img alt="gallery" className="absolute inset-0 w-full h-full  " src="https://i.ibb.co/0rNwYHP/download-12.jpg"/>
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  <h2 className="tracking-widest text-sm title-font font-medium text-green-500 mb-1">CURIOSENSE INNOVATION PRIVATE LIMITED</h2>
                  <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Believes in...</h1>
